...
const CommunicationDetails = ({
 ...
 <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-8">
      <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-lg sm:p-8">
        ...
        {/* Next */}
        <Link
        to="/abha-address-suggestion"
          type="button"
          onClick={handleNext}
          disabled={loading}
          className="mt-8 flex w-full items-center justify-center gap-2 rounded-lg bg-orange-600 px-5 py-3.5 font-semibold text-white transition disabled:cursor-not-allowed disabled:bg-gray-300"
        >
