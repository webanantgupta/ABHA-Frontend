...
// // import AppointmentDetails from "./AppointmentDetailes";
...
//   console.log(
//     "Appointment received from form:",
//     appointment
//   );
...
//   const formatTimeFromBackend = (time: string) => {
...
//         <p className="mt-2 text-sm leading-6 text-gray-500">
//           ABHA profile information was not received
//           from the server.
//         </p>
...
//               <p className="mt-1 text-xs text-gray-500">
//                 Status of the mobile number associated
//                 with ABHA
//               </p>
...
//               <p className="mt-1 text-sm text-gray-500">
//                 Health-record addresses associated
//                 with this profile
//               </p>
